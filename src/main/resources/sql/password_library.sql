...
comment on column xf_password_library.see_time is '查看时间';
comment on column xf_password_library.created_at is '创建时间';
comment on column xf_password_library.updated_at is '修改时间';
comment on column xf_password_library.deleted_at is '删除时间';
